 ...
 */ (function(
  ...
  L.jqplot.support_canvas = function() {
    if (typeof L.jqplot.support_canvas.result == "undefined") {
      L.jqplot.support_canvas.result = !!document.createElement("canvas")
        .getContext;
    }
  ...
  function R() {
    ...
    this.draw = function() {
      if (this.drawIfHidden || this.target.is(":visible")) {
        ...
        var au =
          (this._width - this._gridPadding.left - this._gridPadding.right) / 2 +
        ...
        switch (aO.renderer.constructor) {
          ...
          case L.jqplot.BubbleRenderer:
            ...
            if (aO.show) {
              for (var aU = 0; aU < aO.gridData.length; aU++) {
                aQ = aO.gridData[aU];
                aX = Math.sqrt(
                  (aJ - aQ[0]) * (aJ - aQ[0]) + (aI - aQ[1]) * (aI - aQ[1])
                );
          ...
          case L.jqplot.LineRenderer:
            ...
            if (aO.show) {
              if (
                (aO.fill ||
                  (aO.renderer.bands.show && aO.renderer.bands.fill)) &&
            ...
            switch (aD) {
              case "xaxis":
                if (
                  an.showGridline &&
                  this.drawGridlines &&
                  ((!an.isMinorTick && ah.drawMajorGridlines) ||
                    (an.isMinorTick && ah.drawMinorGridlines))
                ) {
                ...
                if (
                  an.showMark &&
                  an.mark &&
                  ((!an.isMinorTick && ah.drawMajorTickMarks) ||
                    (an.isMinorTick && ah.drawMinorTickMarks))
                ) {
                  ap = an.markSize;
                  aq = an.mark;
                  var ak = Math.round(ah.u2p(an.value)) + 0.5;
  ...
  function J(aJ) {
    ...
    for (var al = 1, aB = aJ.length; al < aB; al++) {
          ...
          if (aw[aE + 1] - aw[aE] == 0 || aw[aE] - aw[aE - 1] == 0) {
            ...
            if (
              ...
              if ((aw[aE + 1] - aw[aE]) * (aw[aE] - aw[aE - 1]) < 0) {
                ...
                ai[aC] =
                  2 /
                  (av(ak[aE + 1], ak[aE]) / (aw[aE + 1] - aw[aE]) +
                    av(ak[aE], ak[aE - 1]) / (aw[aE] - aw[aE - 1]));
              }
            }
          }
        }
      ...
      if (al == 1) {
        ...
        if (al == ah) {
          ai[1] =
            ((3 / 2) * (aw[ah] - aw[ah - 1])) / av(ak[ah], ak[ah - 1]) -
            ai[0] / 2;
        }
      }
      au[0] =
        (-2 * (ai[1] + 2 * ai[0])) / av(ak[al], ak[al - 1]) +
        (6 * (aw[al] - aw[al - 1])) / Math.pow(av(ak[al], ak[al - 1]), 2);
      au[1] =
  ...
  function F(ap) {
    ...
    for (var aQ = 0, aP = ap.length - 1; aQ < aP; aQ++) {
      if (aU === null) {
        ...
        if (aQ > 0) {
          aR = Math.abs(
            (ap[aQ][1] - ap[aQ - 1][1]) / (ap[aQ][0] - ap[aQ - 1][0])
          );
        }
        am = aR / aG + aE;
    ...
    if (aK.length) {
      ...
      if (
        ...
        if (this.autoscale && this.min == null && this.max == null) {
          ...
          if (aC) {
            this.numberTicks =
              2 + Math.ceil((ah - (this.tickSpacing - 1)) / this.tickSpacing);
            this.min = 0;
            aH = 0;
            ...
            if (aN) {
              ...
              if (this.numberTicks == null) {
                if (this.tickInterval) {
                  ...
                  this.numberTicks =
                    2 +
                    Math.ceil((ah - (this.tickSpacing - 1)) / this.tickSpacing);
                }
              }
                ...
                if (a5 == null && aH == null) {
                  ...
                  if (a5 == null) {
                    ...
                    if (aH == null) {
                      ...
                      this.numberTicks =
                        Math.ceil((a5 - aH) / this.tickInterval) + 1;
                      this.min =
                        Math.floor(aH * Math.pow(10, a3)) / Math.pow(10, a3);
                      this.max =
                        Math.ceil(a5 * Math.pow(10, a3)) / Math.pow(10, a3);
                      this.numberTicks =
    ...
    if (this.breakPoints) {
      ...
      this.u2p = function(aA) {
        ...
        if (aA <= this.breakPoints[0]) {
          ...
          return (
            ((aA - this.breakPoints[1] + this.breakPoints[0] - at) * ak) / al +
            am
          );
        }
      };
      if (this.name.charAt(0) == "x") {
        ...
        this.series_u2p = function(aA) {
          ...
          if (aA >= this.breakPoints[1]) {
            ...
            return (
              ((aA + this.breakPoints[1] - this.breakPoints[0] - au) * ak) / al
            );
          }
        };
        this.series_p2u = function(aA) {
    ...
    if (this.show) {
      if (this.placement == "insideGrid") {
        switch (this.location) {
          ...
          case "n":
            var ai =
              (aj.left + (this._plotDimensions.width - aj.right)) / 2 -
              this.getWidth() / 2;
            var ah = aj.top;
            this._elem.css("left", ai);
            this._elem.css("top", ah);
          ...
          case "e":
            var ai = aj.right;
            var ah =
              (aj.top + (this._plotDimensions.height - aj.bottom)) / 2 -
              this.getHeight() / 2;
            this._elem.css({ right: ai, top: ah });
            break;
          case "se":
  ...
  L.fn.jqplotToImageCanvas = function(aj) {
    ...
    var al =
      aj.backgroundColor == null ? "rgb(255,255,255)" : aj.backgroundColor;
        ...
        if (aN === "table" && L(aG).hasClass("jqplot-table-legend")) {
          ...
          L(aG)
            ...
            .each(function() {
              ...
              var aT =
                aU.innerHeight() - 2 * parseInt(aU.css("padding-top"), 10);
              var aP =
                aU.innerWidth() - 2 * parseInt(aU.css("padding-left"), 10);
          ...
          L(aG)
            ...
            .each(function() {
              ...
              var aQ =
                aL + aR.position().top + parseInt(aR.css("padding-top"), 10);
  ...
  L.jqplot.sprintf = function() {
    function an(au, ap, aq, at) {
      var ar =
        au.length >= ap ? "" : Array((1 + ap - au.length) >>> 0).join(aq);
    ...
    return am.replace(L.jqplot.sprintf.regex, function(
      ...
      switch (av) {
        ...
        case "P":
          ...
          var aq =
            aE[0].indexOf(".") != -1 ? aE[0].length - 1 : String(ar).length;
