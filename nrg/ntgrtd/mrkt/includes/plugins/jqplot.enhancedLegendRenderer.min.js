 ...
 */ (function(
  ...
  c.jqplot.EnhancedLegendRenderer.prototype.constructor =
    c.jqplot.EnhancedLegendRenderer;
    ...
    if (this.show) {
      ...
      w +=
        this.marginRight != null
          ...
          : "";
      this._elem = c(
        '<table class="jqplot-table-legend" style="' + w + '"></table>'
      );
      if (this.seriesToggle) {
    ...
    var e = function() {
      if (k) {
        ...
        if (g && f) {
          ...
          d.canvas._elem
            .nextAll(".jqplot-point-label.jqplot-series-" + d.index)
            .hide()
            .fadeIn(f);
        }
      } else {
        ...
        if (d.canvas._elem.is(":hidden") || !d.show) {
          if (
            typeof h.options.legend.showSwatches === "undefined" ||
          ...
          if (
            typeof h.options.legend.showLabels === "undefined" ||
  ...
  var b = function() {
    if (
      this.legend.renderer.constructor == c.jqplot.EnhancedLegendRenderer &&
