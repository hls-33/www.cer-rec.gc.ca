      ...
      if (this.min == null && this.max == null && H.min == H.max) {
        ...
        if (this.min == null && this.max == null) {
          ...
          if (!this.tickInterval && !this.numberTicks) {
            ...
            if (
              ...
              Z =
                115 -
                40 *
                  Math.abs(Math.sin((this.tickOptions.angle / 180) * Math.PI));
            }
          ...
          if (I <= 19 * l) {
            ...
            ae = new h.jsDate(ae);
            ae =
              Math.floor((ae.getTime() - ae.getUtcOffset()) / r) * r +
              ae.getUtcOffset();
          ...
          for (var aa = 0; aa < this.numberTicks; aa++) {
            ...
            ad = ae
              .add(aa * this.daTickInterval[0], this.daTickInterval[1])
              .getTime();
            var Y = new this.tickRenderer(this.tickOptions);
            if (!this.showTicks) {
              Y.showLabel = false;
