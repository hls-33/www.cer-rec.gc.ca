 ...
 */ (function(
  ...
  function g(A, q, m) {
    ...
    if (t.useAxesFormatters) {
      ...
      var z;
      if (typeof t.formatString === "string") {
        z = d.jqplot.sprintf.apply(
          d.jqplot.sprintf,
          [t.formatString].concat(m.data)
        );
      } else {
        if (t.tooltipAxes == "both" || t.tooltipAxes == "xy") {
          z =
            d.jqplot.sprintf(t.tooltipFormatString, m.data[0]) +
            t.tooltipSeparator +
            d.jqplot.sprintf(t.tooltipFormatString, m.data[1]);
        } else {
          if (t.tooltipAxes == "yx") {
            z =
              d.jqplot.sprintf(t.tooltipFormatString, m.data[1]) +
    ...
    switch (o[e[t.tooltipLocation]]) {
      ...
      case "n":
        ...
        var n =
          C.y + A._gridPadding.top - t.tooltipOffset - D.outerHeight(true) - v;
        break;
      case "ne":
      ...
      case "w":
        var p =
          C.x + A._gridPadding.left - D.outerWidth(true) - t.tooltipOffset - v;
        var n = C.y + A._gridPadding.top - D.outerHeight(true) / 2;
        break;
      default:
        var p =
  ...
  function f(n, j, i, p, l) {
    ...
    if (h.show) {
      if (p == null && h.isHighlighting) {
        ...
        if (
          p != null &&
          l.series[p.seriesIndex].showHighlight &&
          !h.isHighlighting
        ) {
