 ...
 */ (function(
  ...
  function g(t, p, o, w) {
    ...
    if (this.rendererOptions.waterfall == true) {
      ...
      this._data[this._data.length] =
        u == 1 ? [this._data.length + 1, s] : [s, this._data.length + 1];
    }
  ...
  d.jqplot.BarRenderer.prototype.setBarWidth = function() {
    ...
    if (t.name == "xaxis" || t.name == "x2axis") {
      if (this._stack) {
        this.barWidth =
          ((t._offsets.max - t._offsets.min) / n) * o - this.barMargin;
      } else {
        this.barWidth =
      ...
      if (this._stack) {
        this.barWidth =
          ((t._offsets.min - t._offsets.max) / n) * o - this.barMargin;
      } else {
        this.barWidth =
  ...
  d.jqplot.BarRenderer.prototype.draw = function(E, L, q, G) {
    ...
    if (this._stack) {
      ...
      this._barNudge =
        (-Math.abs(v / 2 - 0.5) + s) * (this.barWidth + this.barPadding);
    }
    if (O) {
  ...
  d.jqplot.BarRenderer.prototype.drawShadow = function(z, G, p, B) {
    ...
    if (this._stack && this.shadow) {
      ...
      var H = (this._plotSeriesInfo = this.renderer.calcSeriesNumbers.call(
        this
      ));
      u = H[0];
      s = H[1];
      ...
      if (this._stack) {
        ...
        this._barNudge =
          (-Math.abs(s / 2 - 0.5) + r) * (this.barWidth + this.barPadding);
      }
      if (I) {
        if (this.barDirection == "vertical") {
