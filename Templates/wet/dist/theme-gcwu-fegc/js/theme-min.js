 ...
 *
 * Version: v3.1.12 Build: 2014-06-17 04:37 PM EDT
 *
 */
(function(c) {
  var b, a;
  b =
    typeof window.wet_boew_theme !== "undefined" &&
    window.wet_boew_theme !== null
      ? window.wet_boew_theme
      : { fn: {} };
  a = {
    ...
    init: function() {
      ...
      var i = pe.menu.navcurrent(b.menubar, b.bcrumb),
        h = i.parents("div.mb-sm"),
        d,
        g,
        k,
        f,
      ...
      if (!pe.svg || pe.svgfix) {
        e = b.sft.length !== 0;
        j = function(m) {
          var n = c("#gcwu-wmms img, #gcwu-sig img, #gcwu-sig-coa img").get(),
            l = n.length,
            o;
          while (l--) {
            o = n[l];
            o.src = m
              ? o.src.replace(".png", "-alt.png")
              : o.src.replace("-alt.png", ".png");
          }
        };
        if (e) {
        ...
        g = c("#gcwu-wmms-in, #gcwu-sig-in, #gcwu-sig-coa-in").get();
        d = g.length;
        while (d--) {
          k = g[d];
    ...
    mobileview: function() {
      var A,
        ...
        e,
        p,
        ac = pe.dic.get("%settings"),
        E = pe.dic.get("%hyphen") + pe.dic.get("%main-page"),
        F,
        v,
        f,
        n,
        aa,
        af = "",
        x = '<a data-role="button" data-iconpos="notext"',
        H = ' data-rel="popup" data-position-to="window"',
        r = x + H,
        I = '<div data-role="popup" data-overlay-theme="a"',
        L = '<div data-role="header"',
        ae = L + "><h1>",
        G = ' data-theme="c" class="ui-corner-all">',
        s = L + ' class="ui-corner-top"><h1>',
        h =
          '<div data-role="content" data-theme="c" class="ui-corner-bottom ui-content">',
        ab =
          x +
          ' href="javascript:;" data-icon="delete" data-rel="back" class="ui-btn-right">' +
          pe.dic.get("%close") +
          "</a>",
        W = r + ' data-icon="back" class="ui-btn-left"',
        U = ">" + pe.dic.get("%back") + "</a>",
        ad = "</div></div>",
        q = '<ul data-role="listview"',
        B = "",
        P,
        m,
        w,
        ...
        O,
        z =
          typeof wet_boew_mobile_view !== "undefined" &&
          wet_boew_mobile_view.header_fixed;
      if (b.sft.length !== 0) {
        if (
          b.menubar.length !== 0 ||
          pe.secnav.length !== 0 ||
          ...
          v =
            pe.secnav.length !== 0
              ? pe.secnav[0].getElementsByTagName("h2")[0]
              : "";
          A =
            I +
            ' id="jqm-wb-mb" class="jqm-wb-mb">' +
            ae +
            e +
            "</h1>" +
            ab +
            '</div><div data-role="content" data-inset="true"><nav role="navigation">';
          if (b.bcrumb.length !== 0) {
            ...
            A +=
              '<section><div id="jqm-mb-location-text">' +
              K.innerHTML +
              "</div></section>";
          } else {
          ...
          if (b.menubar.length !== 0) {
            T +=
              "<section><div><h2>" +
              b.psnb.children(":header")[0].innerHTML +
              "</h2>" +
              pe.menu.buildmobile(g, 3, "a", true, true, "c", true, true) +
              "</div></section>";
          }
        ...
        l =
          ...
          (z ? ' data-position="fixed"' : "") +
          '><div class="ui-title"><div></div></div><map id="gcwu-mnavbar" data-role="controlgroup" data-type="horizontal" class="ui-btn-right wb-hide">';
        ...
        l +=
          r +
          ' href="#popupSettings" data-icon="gear">' +
          ac +
          "</a></map></div>";
        ...
        if (J !== null) {
          ...
          X = J.getElementsByClassName("session")[0].getElementsByTagName(
            "a"
          )[0];
          F +=
            '<li><a href="' +
        ...
        if (t.length !== 0) {
          F +=
            '<li><a href="#popupLanguages"' +
            H +
            ">" +
            pe.dic.get("%languages") +
            "</a></li>";
        }
        F +=
          '<li class="ui-corner-bottom"><a href="#popupAbout"' +
          H +
          ">" +
          pe.dic.get("%about") +
          "</a></li>";
        ...
        if (t.length !== 0) {
          ...
          if (t.filter('[id*="-lang-current"]').length === 0) {
            F +=
              '<li><a href="javascript:;" class="ui-disabled">' +
              pe.dic.get("%lang-native") +
              ' <span class="current">' +
              pe.dic.get("%current") +
              "</span></a></li>";
          }
          ...
          while (Z--) {
            ...
            if (K.id.indexOf("-lang-current") !== -1) {
              F +=
                '><a href="javascript:;" class="ui-disabled">' +
                K.innerHTML +
                ' <span class="current">' +
                pe.dic.get("%current") +
                "</span></a></li>";
        ...
        F +=
          I +
          ' id="popupAbout" data-theme="c" class="ui-corner-all jqm-wb-mb">';
        F +=
          s +
          pe.dic.get("%about") +
          "</h1>" +
        ...
        F += h;
        F +=
          '<div class="site-app-title"><div class="ui-title">' +
          b.title[0].getElementsByTagName("a")[0].innerHTML +
          "</div></div>";
        ...
        F +=
          '<div data-role="controlgroup" data-theme="c"><div data-role="collapsible-set" data-inset="false">';
        F += q + ">";
        P = document.getElementById("gcwu-tctr").getElementsByTagName("a");
        for (Z = 0, y = P.length; Z !== y; Z += 1) {
          m = P[Z];
          F +=
            '<li class="top-level' +
            (Z === 0 ? " ui-corner-top" : "") +
        ...
        for (Z = 0; Z !== y; Z += 1) {
          ...
          if (k.length !== 0) {
            ...
            F +=
              '<div class="wb-nested-menu" data-role="collapsible"><h2>' +
              d +
              "</h2>" +
              q +
              ">";
            P = k[0].getElementsByTagName("a");
            for (Y = 0, o = P.length; Y !== o; Y += 1) {
              K = P[Y];
        ...
        u = b.gcnb.find("#gcwu-sig-in, #gcwu-sig-coa-in").children();
        if (u.length !== 0) {
          F +=
            '<div class="wb-nested-menu" data-role="collapsible"><h2>' +
            (typeof u.attr("aria-label") !== "undefined"
              ? u.attr("aria-label")
              : u.attr("alt")) +
            "</h2>" +
            q +
            ...
            if (O.indexOf("gcwu-gcnb-lang") === -1 && O !== "gcwu-gcft-ca") {
              ...
              if (m.length !== 0) {
                ...
                F +=
                  '<li><a href="' +
                  m.href +
                  (m.hasAttribute("target")
                    ? '" target="' + m.getAttribute("target")
                    : "") +
                  '">' +
                  m.innerHTML +
                  "</a></li>";
        ...
        c(".button-group input, .button-group button, input[type=search]").attr(
          "data-role",
          "none"
        );
      } else {
          ...
          for (Z = 0, y = Q.length; Z < y; Z += 1) {
            ...
            w +=
              ...
              (K.hasAttribute("lang")
                ? ' lang="' + K.getAttribute("lang") + '"'
                : "") +
              ' data-role="button" data-theme="c" data-corners="false">' +
              m.innerHTML +
              "</a></li>";
          }
          w += "</ul>";
      ...
      D.on("pagecreate", function() {
        var aj = b.gcnb.find("#gcwu-mnavbar"),
          ak = pe.bodydiv.find("#jqm-mb-menu"),
          ai,
          ag,
          ah,
          j;
          ...
          if (ak.length !== 0) {
            ...
            aj.find('a[href="#jqm-wb-mb"]').one("click vclick", function() {
              ...
              while (j--) {
                ...
                if (
                  ah.parentNode.parentNode.parentNode.className.indexOf(
                    "ui-collapsible"
                  ) === -1 &&
                  ah.className.indexOf("ui-corner-top") === -1
                ) {
                ...
                if (
                  typeof ah !== "undefined" &&
                  ah.className.indexOf("ui-corner-bottom") === -1
                ) {
