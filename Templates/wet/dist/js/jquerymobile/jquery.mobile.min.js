  ...
  !(function(a) {
    ...
    (function(a) {
      ...
      a.widget("mobile.loader", {
        ...
        fakeFixLoader: function() {
          ...
          this.element.css({
            top:
              (a.support.scrollTop && e.scrollTop() + e.height() / 2) ||
        ...
        show: function(f, g, h) {
          ...
          this.resetHtml(),
            "object" === a.type(f)
              ? ((k = a.extend({}, this.options, f)),
                (f = k.theme || a.mobile.loadingMessageTheme))
              : ((k = this.options),
    ...
    (function(a, d) {
      ...
      function g() {
        ...
        for (var i in h)
          g.style[i] !== d &&
            ((g.style[i] = "translate3d( 100px, 1px, 1px )"),
    ...
    (function(a, d) {
      function e(b) {
        !p ||
          (p.closest("." + a.mobile.activePageClass).length && !b) ||
          p.removeClass(a.mobile.activeBtnClass),
          (p = null);
      }
      function f() {
      ...
      var l = a.mobile.window,
        ...
        z = a.support.dynamicBaseTag
          ? {
              element: v.length
                ? v
                : a("<base>", { href: x.hrefNoHash }).prependTo(m),
              set: function(a) {
      ...
      (A = function() {
        ...
        (a.mobile.loadPage = function(b, c) {
          ...
          f.data &&
            "get" === f.type &&
            ((k = n.addSearchParams(k, f.data)), (f.data = d)),
          ...
          return (
            !z ||
              ("undefined" != typeof c && "undefined" != typeof c.prefetch) ||
              z.reset(),
        ...
        (a.mobile.changePage = function(b, j) {
          ...
          if (
            ((p.absUrl = k ? n.makeUrlAbsolute(b, i()) : b.data("absUrl")),
            m.trigger(o, p),
            ...
            b[0] !== a.mobile.firstPage[0] ||
              l.dataUrl ||
              (l.dataUrl = w.hrefNoHash);
            var q = l.fromPage,
              v =
                (l.dataUrl && n.convertUrlToDataUrl(l.dataUrl)) ||
                b.jqmData("url"),
              x = v,
            ...
            if (q && q[0] === b[0] && !l.allowSamePageTransition)
              return (
                ...
                l.fromHashChange && r.direct({ url: v }),
                void 0
              );
            h(b, l.role),
            ...
            if (
              ...
              !n.isPath(v) && v.indexOf("#") < 0 && (v = "#" + v),
                ...
                l.changeHash !== !1 && a.mobile.hashListeningEnabled
                  ...
                  : b[0] !== a.mobile.firstPage[0] &&
                    a.mobile.navigate.history.add(v, G);
            }
            (c.title = B),
              ...
              if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                if (((o = a(g)), a.data(g, "mobile-button"))) {
                  ...
                  if (
                    ((g = j(g)),
                    !g ||
                      "#" === n.parseUrl(g.getAttribute("href") || "#").hash)
                  )
                    return;
                ...
                ~g.className.indexOf("ui-link-inherit")
                  ...
                  d.length > 0 &&
                    ...
                    (e(!0), (p = d), p.addClass(a.mobile.activeBtnClass));
              }
            }),
              ...
              if (a.mobile.linkBindingEnabled && !c.isDefaultPrevented()) {
                ...
                if (g && !(c.which > 1) && h.jqmHijackable().length) {
                  ...
                  if (-1 !== l.search("#")) {
                    ...
                    l = n.isPath(l)
                      ? n.makeUrlAbsolute(l, i)
                      : n.makeUrlAbsolute("#" + l, w.hrefNoHash);
                  }
                  var m =
                      h.is("[rel='external']") ||
                      h.is(":jqmData(ajax='false')") ||
                      h.is("[target]"),
                    o =
                      m ||
                      (n.isExternal(l) &&
                        !n.isPermittedCrossDomainRequest(w, l));
                  if (o) return f(), void 0;
                  var p = h.jqmData("transition"),
                    q =
                      "reverse" === h.jqmData("direction") || h.jqmData("back"),
              ...
              d.length &&
                ...
                d
                  .attr(
                    ...
                    c.transition || a.mobile.defaultDialogTransition
                  )
          ...
          a(
            ...
            .each(function() {
              ...
              if ((j.addClass("ui-" + k), "header" === k || "footer" === k)) {
                var n =
                  l || ("header" === k ? d.headerTheme : d.footerTheme) || f;
                j
                  .addClass("ui-bar-" + n)
                  .attr("role", "header" === k ? "banner" : "contentinfo"),
                  "header" === k &&
      ...
      (a.fn.buttonMarkup = function(d) {
        ...
        for (var j = 0; j < h.length; j++) {
            ...
            s = a.extend(
              ...
              a.fn.buttonMarkup.defaults,
              {
                ...
                theme:
                  d.theme !== b
                    ? d.theme
                    : f(r, i + "theme") || a.mobile.getInheritedTheme(q, "c"),
                ...
                iconshadow:
                  d.iconshadow !== b ? d.iconshadow : f(r, i + "iconshadow"),
          ...
          for (e in s)
            s[e] === b || null === s[e]
              ? q.removeAttr(i + e)
              : r.setAttribute(i + e, s[e]);
          for (
            p = a.data(
              "INPUT" === r.tagName || "BUTTON" === r.tagName
                ? r.parentNode
                : r,
              "buttonElements"
            ),
              p
                ? ((r = p.outer),
                  ...
                  (v = p.hover),
                  (w = p.state))
                : ((m = c.createElement(s.wrapperEls)),
              ...
              s.mini !== b &&
                (k += s.mini === !0 ? " ui-mini" : " ui-fullsize"),
              s.inline !== b &&
                (k += s.inline === !0 ? " ui-btn-inline" : " ui-btn-block"),
              s.icon &&
              ...
              o &&
                ((o.className = l),
                (p && p.icon) || ((o.innerHTML = "&#160;"), m.appendChild(o)));
            r.firstChild && !p;
      ...
      a.fn.grid = function(b) {
        return this.each(function() {
          ...
          (c = g[h]),
            ...
            c > 1 &&
              f.filter(":nth-child(" + c + "n+2)").addClass("ui-block-b"),
            c > 2 &&
              f.filter(":nth-child(" + c + "n+3)").addClass("ui-block-c"),
            c > 3 &&
              f.filter(":nth-child(" + c + "n+4)").addClass("ui-block-d"),
            c > 4 &&
              f.filter(":nth-child(" + c + "n+5)").addClass("ui-block-e");
        });
      };
    })(a),
    (function(a, b) {
        ...
        a.extend(
          {
            ...
            refresh: function(b) {
                ...
                w &&
                  (y || 0 === y
                    ? x
                      ? (j = parseInt(y, 10))
                      : ((k = parseInt(y, 10) - 1),
                        q.css("counter-reset", "listnumbering " + k))
                    : x && (j = 1)),
                p.theme ||
                  (p.theme = a.mobile.getInheritedTheme(this.element, "c"));
              for (var A = 0, B = v.length; B > A; A++) {
                if (((d = v.eq(A)), (e = "ui-li"), b || !d.hasClass("ui-li"))) {
                  ...
                  g.length && !C
                    ...
                    : C
                    ? ((e +=
                        " ui-li-divider ui-bar-" + (d.jqmData("theme") || r)),
                      d.attr("role", "heading"),
                      w &&
                        (y || 0 === y
                          ? x
                            ? (j = parseInt(y, 10))
                            : ((l = parseInt(y, 10) - 1),
                              d.css("counter-reset", "listnumbering " + l))
                          : x && (j = 1)))
                ...
                w &&
                  ...
                  ((m =
                    e.indexOf("ui-li-static") > 0
                      ? d
                      : d.find(".ui-link-inherit")),
                  m
                    .addClass("ui-li-jsnumbering")
                    .prepend("<span class='ui-li-dec'>" + j++ + ". </span>")),
                  z[e] || (z[e] = []),
                  z[e].push(d[0]);
              }
              for (e in z)
              ...
              q
                ...
                .addClass(
                  "ui-btn-up-" +
                    (q.jqmData("counttheme") || this.options.countTheme) +
                    " ui-btn-corner-all"
                ),
            ...
            _createSubPages: function() {
              ...
              if (
                ...
                a(
                  ...
                  .listview(),
                c &&
                  e.is(":jqmData(external-page='true')") &&
                  e.data("mobile-page").options.domCache === !1)
              ) {
                var m = function(b, c) {
                  var d,
                    g = c.nextPage,
            ...
            childPages: function() {
              ...
              return a(
                ":jqmData(url^='" + b + "&" + a.mobile.subPageUrlKey + "')"
              );
            }
          },
          a.mobile.behaviors.addFirstLastClasses
        ...
        _create: function() {
          ...
          if (
            ...
            "undefined" == typeof f[0].autocorrect ||
              ...
              (f[0].setAttribute("autocorrect", "off"),
            ...
            (this._keyup = function() {
              ...
              a.trim(f.val()) &&
                this._on(!0, a.mobile.window, { load: "_keyup" });
          }
        ...
        a.mobile.document.delegate("ul,ol", "listviewcreate", function() {
          ...
          if (d && d.options.autodividers) {
            var e = function() {
                ...
                for (
                  var e, f, g = b.find("li"), h = null, i = 0;
                  i < g.length;
                  i++
                ) {
                  if (
                ...
                (p.className = "ui-" + i),
                  ...
                  h.bind({
                    vmouseover: function(b) {
                      a(this)
                        .parent()
                        .is(".ui-disabled") && b.stopPropagation();
                    },
                    vclick: function(a) {
        ...
        a.extend(
          {
            ...
            _create: function() {
              var e,
                ...
                m =
                  ((this.isToggleSwitch = "select" === l),
                  h.parent().is(":jqmData(role='rangeslider')")),
                ...
                t = this.isToggleSwitch
                  ? h.find("option").length - 1
                  : parseFloat(h.attr("max")),
              ...
              if (
                ...
                y.appendChild(w),
                x.buttonMarkup({ corners: !0, theme: j, shadow: !0 }).attr({
                  role: "slider",
                  "aria-valuemin": s,
                  "aria-valuemax": t,
            ...
            refresh: function(b, d, e) {
              ...
              var n,
                ...
                u =
                  q && parseFloat(p.attr("step")) > 0
                    ? parseFloat(p.attr("step"))
                    : 1;
              if ("object" == typeof b) {
                if (
                  ((h = b),
                ...
                null == b &&
                  (b = q ? parseFloat(p.val() || 0) : p[0].selectedIndex),
    ...
    (function(a) {
      a.widget("mobile.rangeslider", a.mobile.widget, {
        ...
        _slidedrag: function(b) {
          ...
          return (
            ...
            ("first" === this._proxy && c) || ("last" === this._proxy && !c)
              ? ((a.data(d.get(0), "mobileSlider").dragging = !0),
        ...
        _updateHighlight: function() {
          var b = parseInt(
              a.data(this._inputFirst.get(0), "mobileSlider").handle.get(0)
                .style.left,
              10
            ),
            c = parseInt(
              a.data(this._inputLast.get(0), "mobileSlider").handle.get(0).style
                .left,
              10
            ),
            d = c - b;
        ...
        a.extend(
          {
            ...
            _preExtension: function() {
              ...
              ~this.element[0].className.indexOf("ui-btn-left") &&
                ...
                (this.label = a("label[for='" + this.selectID + "']").addClass(
                  "ui-select"
                )),
              ...
              a.length > 0 &&
                (a.is(".ui-btn-left, .ui-btn-right") &&
                  this.element.addClass(
                    a.is(".ui-btn-left") ? "ui-btn-left" : "ui-btn-right"
                  ),
            ...
            _create: function() {
              ...
              this.setButtonText(),
                d.nativeMenu &&
                  b.opera &&
                  b.opera.version &&
                  h.addClass("ui-select-nativeonly"),
                this.isMultiple &&
      ...
      a.widget("mobile.popup", a.mobile.widget, {
        ...
        _create: function() {
          var b = {
            ...
            e = this.options;
          (e.history =
            e.history && a.mobile.ajaxEnabled && a.mobile.hashListeningEnabled),
            0 === c.length && (c = a("body")),
            ...
            this.element
              ...
              .toggleClass("ui-corner-all", e.corners),
        ...
        _placementCoords: function(a) {
          ...
          return (
            (d.y -= Math.min(d.y, Math.max(0, d.y + b.cy - k))),
            { left: d.x, top: d.y }
          );
        },
    ...
    (function(a, b) {
      var d = function(d) {
        var e,
          ...
          u = a("<ul>", {
            ...
            .attr(
              "data-" + a.mobile.ns + "divider-theme",
              d.options.dividerTheme
            )
            .appendTo(t),
          v = a("<div>", {
          ...
          a.extend(d, {
            ...
            build: function() {
              ...
              c.refresh(),
                c._origTabIndex === b &&
                  (c._origTabIndex =
                    null === c.select[0].getAttribute("tabindex")
                      ? !1
              ...
              for (
                ...
                !f ||
                  (t.getAttribute("value") &&
                    0 !== w.length &&
                    !u.jqmData("placeholder")) ||
                  ((f = !1),
                  (r = !0),
                  null === t.getAttribute(p) &&
                    (this._removePlaceholderAttr = !0),
                  t.setAttribute(p, !0),
                  d.hidePlaceholderMenuItems &&
                    y.push("ui-selectmenu-placeholder"),
      ...
      a.mobile.document.bind("selectmenubeforecreate", function(b) {
        ...
        c.options.nativeMenu ||
          0 !== c.element.parents(":jqmData(role='popup')").length ||
          d(c);
      });
    })(a),
    (function(a, b) {
          ...
          f.closest(".ui-page")
            ...
            .bind("focusin focusout", function(f) {
              screen.width < 1025 &&
                ...
                !a(f.target).closest(".ui-header-fixed, .ui-footer-fixed")
                  .length &&
                ("focusout" !== f.type || g
                  ? "focusin" === f.type &&
                    g &&
          ...
          function(c) {
            ...
            "columntoggle" === k.mode &&
              ("refresh" !== j &&
                ...
                (f = a(
                  "<fieldset data-" + l + "role='controlgroup'></fieldset>"
                ))),
            ...
            if ("reflow" === f.mode) {
              ...
              g.each(function() {
                var b = a(this).jqmData("cells"),
                  ...
                  d =
                    b.not(this).filter("thead th").length &&
                ...
                if ("" !== e)
                  if (d) {
                    ...
                    b.prepend(
                      "<b class='" + f.classes.cellLabels + "'>" + e + "</b>"
                    );
              });
            }
          }
            ...
            initializePage: function() {
              ...
              e.length ||
                ...
                (a(h).is(':jqmData(role="page")') ||
                  ...
                  : (a.mobile.path.isHashValid(location.hash) &&
                      (a.mobile.urlHistory.initialDst = g.replace("#", "")),
                    a.event.special.navigate.isPushStateEnabled() &&
          ...
          a(function() {
            b.scrollTo(0, 1),
              ...
              a.support.cssPointerEvents ||
                a.mobile.document.delegate(".ui-disabled", "vclick", function(
                  a
                ) {
